    ...
    return {
      images: [
        ...
        },
        {
          ...
          alt: "",
          class: "md:col-span-4 md:row-span-2 lg:row-start-3 lg:col-start-10",
        },
        {
          order: "04",
          ...
          alt: "",
          class: "lg:row-start-4 lg:col-start-7",
        },
        {
          order: "05",
          ...
          alt: "",
          class: "lg:row-start-4 lg:col-start-10 object-top sm:object-center",
        },
      ],
    };
  },
