    ...
    <div>
      ...
      >
        ...
        <h3 class="text-green col-start-2 col-span-full">
          <span class="font-normal"># </span>1E292B
          <span class="font-normal">Charelstone Green</span>
        </h3>
        <div
        ...
        <h3 class="text-brown col-start-2 col-span-full">
          <span class="font-normal"># </span>231F20
          <span class="font-normal">Raisin Black</span>
        </h3>
        <div
        ...
        <h3 class="text-gold col-start-2 col-span-full">
          <span class="font-normal"># </span>AC9E7B
      ...
      >
        ...
        />
        <div
          class="fox-grid-item col-start-2 col-span-full h-1/4 self-center rounded-foxlg bg-gradient-to-r from-bone to-green shadow-fox_l"
        />
        <h3 class="text-bone col-start-2 col-span-full">
          <span class="font-normal"># </span>F6F1DD
          <span class="font-normal">Eggshell</span>
        </h3>
      </div>
    </div>
  </SetFoxContent>
